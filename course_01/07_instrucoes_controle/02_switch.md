...
- Homework
  ...
  - [Homework: App com menu](#homework-app-com-menu)
- Projetos
  - [Projeto 1](./02_arquivos/proj_01/) [(iniciado em)](#instruções-switch)
- Exercícios
  - [Exercício 1](./02_arquivos/exercicio_01/) ([enunciado](#homework-app-com-menu))
- Conteúdo
...
> Exercício 1 (Construção de switch): [02_arquivos/exercicio_01](./02_arquivos/exercicio_01/)
